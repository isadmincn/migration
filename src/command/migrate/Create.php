...
namespace isadmin\migration\command\migrate;
...
class Create extends AbstractCommand
{
    ...
    protected function configure()
    {
        ...
        // 表注释
        $this->addOption('comment', 'c', InputOption::VALUE_REQUIRED, 'table comment');
        // 是否有状态字段
        $this->addOption('withoutState', 'w', InputOption::VALUE_NONE, 'table without state field');
    }
    ...
    protected function handle(InputInterface $input, OutputInterface $output)
    {
        ...
        $classes  = [
            ...
            '$tableComment'       => $input->getOption('comment') ?? '',
            '$withoutState'        => $input->getOption('withoutState') ? 'false' : '',
        ];
